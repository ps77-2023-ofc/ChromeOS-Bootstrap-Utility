...
echo "PROCESADOR OBJETIVO: Intel Atom, plataforma Coffee Lake (10ª Gen)"
    cat << "Q131-7"
...
if [ "$coffee_cros_version" == "1" ]; then
...
elif [ "$coffee_cros_version" == "2" ]; then
    echo "PROCESADOR OBJETIVO: Intel Atom, plataforma Coffee Lake (10ª Gen)"
    ...
    echo "Comenzando la construcción de la imagen..."
    bash "./cros_workfolder/chromeos-install.sh -src /cros_workfolder/recovery.bin -dst /output/chromeos.img"
elif [ "$coffee_cros_version" == "3" ]; then
    echo "PROCESADOR OBJETIVO: Intel Atom, plataforma Coffee Lake (10ª Gen)"
...
Q14-1
# Leer la respuesta del usuario
read -n 1 coffee_brunch_version_93_cros_version
# Limpiar la terminal
clear
# Si la versión escogida es 1 (Chrome OS v92), comenzar la descarga de los archivos necesarios
    if [ "$coffee_brunch_version_93_cros_version" == "1" ]; then
        echo "PROCESADOR OBJETIVO: Intel Atom, plataforma Coffee Lake (10ª Gen)"
        echo "VERSIÓN DE BRUNCH FRAMEWORK: r93"
        ...
        echo "Comenzando la construcción de la imagen..."
        bash "./cros_workfolder/chromeos-install.sh -src /cros_workfolder/recovery.bin -dst /output/chromeos.img"
    elif [ "$coffee_brunch_version_93_cros_version" == "2" ]; then
        echo "PROCESADOR OBJETIVO: Intel Atom, plataforma Coffee Lake (10ª Gen)"
        echo "VERSIÓN DE BRUNCH FRAMEWORK: r93"
...
elif [ "$coffee_cros_version" == "4" ]; then
    echo "PROCESADOR OBJETIVO: Intel Atom, plataforma Coffee Lake (10ª Gen)"
    ...
    echo "Comenzando la construcción de la imagen..."
    bash "./cros_workfolder/chromeos-install.sh -src /cros_workfolder/recovery.bin -dst /output/chromeos.img"
elif [ "$coffee_cros_version" == "5" ]; then
    echo "PROCESADOR OBJETIVO: Intel Atom, plataforma Coffee Lake (10ª Gen)"
...
Q14-2
# Leer la respuesta del usuario
read -n 1 coffee_brunch_version_100_cros_version
# Limpiar la terminal
clear
    if [ "$coffee_brunch_version_100_cros_version" == "1" ]; then
        echo "PROCESADOR OBJETIVO: Intel Atom, plataforma Coffee Lake (10ª Gen)"
        echo "VERSIÓN DE BRUNCH FRAMEWORK: r100"
        ...
        echo "Comenzando la construcción de la imagen..."
        bash "./cros_workfolder/chromeos-install.sh -src /cros_workfolder/recovery.bin -dst /output/chromeos.img"
    elif [ "$coffee_brunch_version_100_cros_version" == "2" ]; then
        echo "PROCESADOR OBJETIVO: Intel Atom, plataforma Coffee Lake (10ª Gen)"
        echo "VERSIÓN DE BRUNCH FRAMEWORK: r100"
        ...
        echo "Comenzando la construcción de la imagen..."
        bash "./cros_workfolder/chromeos-install.sh -src /cros_workfolder/recovery.bin -dst /output/chromeos.img"
    elif [ "$coffee_brunch_version_100_cros_version" == "3" ]; then
        echo "PROCESADOR OBJETIVO: Intel Atom, plataforma Coffee Lake (10ª Gen)"
        echo "VERSIÓN DE BRUNCH FRAMEWORK: r100"
...
elif [ "$coffee_cros_version" == "6" ]; then
    echo "PROCESADOR OBJETIVO: Intel Atom, plataforma Coffee Lake (10ª Gen)"

...
echo "PROCESADOR OBJETIVO: Intel Atom, plataforma Gemini Lake (8ª Gen)"
    cat << "Q131-5"
...
if [ "$gemini_lake_cros_version" == "1" ]; then
...
elif [ "$gemini_lake_cros_version" == "2" ]; then
    echo "PROCESADOR OBJETIVO: Intel Atom, plataforma Gemini Lake (8ª Gen)"
    ...
    echo "Comenzando la construcción de la imagen..."
    bash "/cros_workfolder/chromeos-install.sh -src /cros_workfolder/recovery.bin -dst /output/chromeos.img"
elif [ "$gemini_lake_cros_version" == "3" ]; then
    echo "PROCESADOR OBJETIVO: Intel Atom, plataforma Gemini Lake (8ª Gen)"
    ...
    echo "Comenzando la construcción de la imagen..."
    bash "/cros_workfolder/chromeos-install.sh -src /cros_workfolder/recovery.bin -dst /output/chromeos.img"
elif [ "$gemini_lake_cros_version" == "4" ]; then
    echo "PROCESADOR OBJETIVO: Intel Atom, plataforma Gemini Lake (8ª Gen)"
    ...
    echo "Comenzando la construcción de la imagen..."
    bash "/cros_workfolder/chromeos-install.sh -src /cros_workfolder/recovery.bin -dst /output/chromeos.img"
elif [ "$gemini_lake_cros_version" == "5" ]; then
    echo "PROCESADOR OBJETIVO: Intel Atom, plataforma Gemini Lake (8ª Gen)"
    ...
    echo "Comenzando la construcción de la imagen..."
    bash "/cros_workfolder/chromeos-install.sh -src /cros_workfolder/recovery.bin -dst /output/chromeos.img"
elif [ "$gemini_lake_cros_version" == "6" ]; then
    echo "PROCESADOR OBJETIVO: Intel Atom, plataforma Gemini Lake (8ª Gen)"
    ...
    echo "Comenzando la construcción de la imagen..."
    bash "/cros_workfolder/chromeos-install.sh -src /cros_workfolder/recovery.bin -dst /output/chromeos.img"
elif [ "$gemini_lake_cros_version" == "7" ]; then
    echo "PROCESADOR OBJETIVO: Intel Atom, plataforma Gemini Lake (8ª Gen)"
...
Q14-1
# Leer la respuesta del usuario
read -n 1 gemini_lake_brunch_version_93_cros_version
# Limpiar la terminal
clear
# Si la versión escogida es 1 (Chrome OS v92), comenzar la descarga de los archivos necesarios
    if [ "$gemini_lake_brunch_version_93_cros_version" == "1" ]; then
        echo "PROCESADOR OBJETIVO: Intel Atom, plataforma Gemini Lake (8ª Gen)"
        echo "VERSIÓN DE BRUNCH FRAMEWORK: r93"
        ...
        echo "Comenzando la construcción de la imagen..."
        bash "/cros_workfolder/chromeos-install.sh -src /cros_workfolder/recovery.bin -dst /output/chromeos.img"
    elif [ "$gemini_lake_brunch_version_93_cros_version" == "2" ]; then
        echo "PROCESADOR OBJETIVO: Intel Atom, plataforma Gemini Lake (8ª Gen)"
        echo "VERSIÓN DE BRUNCH FRAMEWORK: r93"
...
elif [ "$gemini_lake_cros_version" == "8" ]; then
    echo "PROCESADOR OBJETIVO: Intel Atom, plataforma Gemini Lake (8ª Gen)"
    ...
    echo "Comenzando la construcción de la imagen..."
    bash "./chromeos-install.sh -src recovery.bin -dst chromeos.img"
elif [ "$gemini_lake_cros_version" == "9" ]; then 
    echo "PROCESADOR OBJETIVO: Intel Atom, plataforma Gemini Lake (8ª Gen)"
...
Q14-2
# Leer la respuesta del usuario
read -n 1 gemini_lake_brunch_version_97_cros_version
# Limpiar la terminal
clear
# Si la versión escogida es 1 (Chrome OS v96), comenzar la descarga de los archivos necesarios
if [ "$gemini_lake_brunch_version_97_cros_version" == "1" ]; then
    echo "PROCESADOR OBJETIVO: Intel Atom, plataforma Gemini Lake (8ª Gen)"
    echo "VERSIÓN DE BRUNCH FRAMEWORK: r97"
    ...
    echo "Comenzando la construcción de la imagen..."
    bash "./chromeos-install.sh -src recovery.bin -dst chromeos.img"
elif [ "$gemini_lake_brunch_version_97_cros_version" == "2" ]; then
    echo "PROCESADOR OBJETIVO: Intel Atom, plataforma Gemini Lake (8ª Gen)"
    echo "VERSIÓN DE BRUNCH FRAMEWORK: r97"
...
elif [ "$gemini_lake_cros_version" == "10" ]; then
    echo "PROCESADOR OBJETIVO: Intel Atom, plataforma Gemini Lake (8ª Gen)"

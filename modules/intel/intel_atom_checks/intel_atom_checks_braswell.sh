...
echo "PROCESADOR OBJETIVO: Intel Atom, plataforma Braswell (3ª Gen)"
    cat << "Q13-2"
...
if [ "$braswell_brunch_version" == "1" ]; then
...
elif [ "$braswell_brunch_version" == "2" ]; then 
    echo "PROCESADOR OBJETIVO: Intel Atom, plataforma Braswell (3ª Gen)"
    echo "VERSIÓN DE BRUNCH FRAMEWORK: r87"
    echo "VERSIÓN DE CHROME OS: v87"
    echo "CODENAME DEL RECOVERY DESTINO: rammus"
    echo "Descargando archivos necesarios..."
    wget -q --show-progress "https://github.com/sebanc/brunch/releases/download/r87-stable-20201216/brunch_r87_stable_20201216.tar.gz" -O brunch.tar.gz -P /cros_workfolder
    ...
    echo "Comenzando la construcción de la imagen..."
    bash "/cros_workfolder/chromeos-install.sh -src /cros_workfolder/recovery.bin -dst output/chromeos.img"
elif [ "$braswell_brunch_version" == "3" ]; then
    echo "PROCESADOR OBJETIVO: Intel Atom, plataforma Braswell (3ª Gen)"
    ...
    wget -q --show-progress "https://web.archive.org/web/20220302163230mp_/https://dl.google.com/dl/edgedl/chromeos/recovery/chromeos_13597.105.0_rammus_recovery_stable-channel_mp-v2.bin.zip" -O recovery.zip -P /cros_workfolder
    echo "Archivos descargados."
    echo "Extrayendo archivos..."
    tar -xzf brunch.tar.gz -C /cros_workfolder
    unzip -qq recovery.zip -d /cros_workfolder
    echo "Archivos extraídos."
    echo "Renombrando archivo del recovery a recovery.bin..."
    mv /cros_workfolder/chromeos_13597.105.0_rammus_recovery_stable-channel_mp-v2.bin /cros_workfolder/recovery.bin
    echo "Comenzando la construcción de la imagen..."
    bash "/cros_workfolder/chromeos-install.sh -src /cros_workfolder/recovery.bin -dst output/chromeos.img"
elif [ "$braswell_brunch_version" == "4" ]; then
    echo "PROCESADOR OBJETIVO: Intel Atom, plataforma Braswell (3ª Gen)"
    ...
    echo "Comenzando la construcción de la imagen..."
    bash "/cros_workfolder/chromeos-install.sh -src /cros_workfolder/recovery.bin -dst output/chromeos.img"
elif [ "$braswell_brunch_version" == "5" ]; then
    echo "PROCESADOR OBJETIVO: Intel Atom, plataforma Braswell (3ª Gen)"
    ...
    echo "Comenzando la construcción de la imagen..."
    bash "/cros_workfolder/chromeos-install.sh -src /cros_workfolder/recovery.bin -dst output/chromeos.img"
elif [ "$braswell_brunch_version" == "6" ]; then
    echo "PROCESADOR OBJETIVO: Intel Atom, plataforma Braswell (3ª Gen)"
    ...
    echo "Comenzando la construcción de la imagen..."
    bash "/cros_workfolder/chromeos-install.sh -src /cros_workfolder/recovery.bin -dst output/chromeos.img"
elif [ "$braswell_brunch_version" == "7" ]; then
    echo "PROCESADOR OBJETIVO: Intel Atom, plataforma Braswell (3ª Gen)"
...
Q14-1
# Leer la respuesta del usuario
read -n 1 braswell_brunch_version_93_cros_version
# Limpiar la terminal
clear
# Si la versión escogida es 1 (Chrome OS v92), comenzar la descarga de los archivos necesarios
    if [ "$braswell_brunch_version_93_cros_version" == "1" ]; then
        echo "PROCESADOR OBJETIVO: Intel Atom, plataforma Braswell (3ª Gen)"
        echo "VERSIÓN DE BRUNCH FRAMEWORK: r93"
        ...
        echo "Comenzando la construcción de la imagen..."
        bash "/cros_workfolder/chromeos-install.sh -src /cros_workfolder/recovery.bin -dst output/chromeos.img"
    elif [ "$braswell_brunch_version_93_cros_version" == "2" ]; then
        echo "PROCESADOR OBJETIVO: Intel Atom, plataforma Braswell (3ª Gen)"
        echo "VERSIÓN DE BRUNCH FRAMEWORK: r93"
...
elif [ "$braswell_brunch_version" == "8" ]; then
    echo "PROCESADOR OBJETIVO: Intel Atom, plataforma Braswell (3ª Gen)"
    ...
    echo "Comenzando la construcción de la imagen..."
    bash "/cros_workfolder/chromeos-install.sh -src /cros_workfolder/recovery.bin -dst output/chromeos.img"
elif [ "$braswell_brunch_version" == "9" ]; then 
    echo "PROCESADOR OBJETIVO: Intel Atom, plataforma Braswell (3ª Gen)"
...
Q14-2
# Leer la respuesta del usuario
read -n 1 braswell_brunch_version_97_cros_version
# Limpiar la terminal
clear
# Si la versión escogida es 1 (Chrome OS v96), comenzar la descarga de los archivos necesarios
    if [ "$braswell_brunch_version_97_cros_version" == "1" ]; then
        echo "PROCESADOR OBJETIVO: Intel Atom, plataforma Braswell (3ª Gen)"
        echo "VERSIÓN DE BRUNCH FRAMEWORK: r97"
        ...
        echo "Comenzando la construcción de la imagen..."
        bash "/cros_workfolder/chromeos-install.sh -src /cros_workfolder/recovery.bin -dst output/chromeos.img"
    elif [ "$braswell_brunch_version_97_cros_version" == "2" ]; then
        echo "PROCESADOR OBJETIVO: Intel Atom, plataforma Braswell (3ª Gen)"
        echo "VERSIÓN DE BRUNCH FRAMEWORK: r97"
...
elif [ "$braswell_brunch_version" == "10" ]; then
    echo "PROCESADOR OBJETIVO: Intel Atom, plataforma Braswell (3ª Gen)"

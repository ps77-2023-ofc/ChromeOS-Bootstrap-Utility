...
echo "PROCESADOR OBJETIVO: AMD Stoney Ridge"
    cat << "Q13-1"
...
elif [ "$amd_stoneyridge_cros_version" == "2" ]; then
    echo "PROCESADOR OBJETIVO: AMD Stoney Ridge"
...
Q14-1
# Leer la respuesta del usuario
read -n 1 amdstoney_brunch_version_86_cros_version
# Limpiar la terminal
clear
# Si la versión escogida es 1 (Chrome OS v92), comenzar la descarga de los archivos necesarios
    if [ "$amdstoney_brunch_version_86_cros_version" == "1" ]; then
        echo "PROCESADOR OBJETIVO: AMD Stoney Ridge"
        echo "VERSIÓN DE BRUNCH FRAMEWORK: r86"
        ...
        echo "Comenzando la construcción de la imagen..."
        bash "/cros_workfolder/chromeos-install.sh -src cros_workfolder/recovery.bin -dst output/chromeos.img"
    elif [ "$amdstoney_brunch_version_86_cros_version" == "2" ]; then
        ...
        echo "Comenzando la construcción de la imagen..."
        bash "/cros_workfolder/chromeos-install.sh -src cros_workfolder/recovery.bin -dst output/chromeos.img"
    elif [ "$amdstoney_brunch_version_86_cros_version" == "3" ]; then
        echo "PROCESADOR OBJETIVO: AMD Stoney Ridge"
        echo "VERSIÓN DE BRUNCH FRAMEWORK: r86"
...
elif [ "$amd_stoneyridge_cros_version" == "3" ]; then
    echo "PROCESADOR OBJETIVO: AMD Stoney Ridge"
    ...
    echo "Comenzando la construcción de la imagen..."
    bash "/cros_workfolder/chromeos-install.sh -src cros_workfolder/recovery.bin -dst output/chromeos.img"
elif [ "$amd_stoneyridge_cros_version" == "4" ]; then
    echo "PROCESADOR OBJETIVO: AMD Stoney Ridge"
    ...
    echo "Comenzando la construcción de la imagen..."
    bash "/cros_workfolder/chromeos-install.sh -src cros_workfolder/recovery.bin -dst output/chromeos.img"
elif [ "$amd_stoneyridge_cros_version" == "5" ]; then
    echo "PROCESADOR OBJETIVO: AMD Stoney Ridge"
    ...
    echo "Comenzando la construcción de la imagen..."
    bash "/cros_workfolder/chromeos-install.sh -src cros_workfolder/recovery.bin -dst output/chromeos.img"
elif [ "$amd_stoneyridge_cros_version" == "6" ]; then
    echo "PROCESADOR OBJETIVO: AMD Stoney Ridge"
    ...
    echo "Comenzando la construcción de la imagen..."
    bash "/cros_workfolder/chromeos-install.sh -src cros_workfolder/recovery.bin -dst output/chromeos.img"
elif [ "$amd_stoneyridge_cros_version" == "7" ]; then 
    echo "PROCESADOR OBJETIVO: AMD Stoney Ridge"
...
Q14-2
# Leer la respuesta del usuario
read -n 1 amdstoney_brunch_version_93_cros_version
# Limpiar la terminal
clear
# Si la versión escogida es 1 (Chrome OS v96), comenzar la descarga de los archivos necesarios
    if [ "$amdstoney_brunch_version_93_cros_version" == "1" ]; then
        echo "PROCESADOR OBJETIVO: AMD Stoney Ridge"
        echo "VERSIÓN DE BRUNCH FRAMEWORK: r93"
        ...
        echo "Comenzando la construcción de la imagen..."
        bash "/cros_workfolder/chromeos-install.sh -src cros_workfolder/recovery.bin -dst output/chromeos.img"
    elif [ "$amdstoney_brunch_version_93_cros_version" == "2" ]; then
        echo "PROCESADOR OBJETIVO: AMD Stoney Ridge"
        echo "VERSIÓN DE BRUNCH FRAMEWORK: r93"
...
elif [ "$amd_stoneyridge_cros_version" == "8" ]; then
    echo "PROCESADOR OBJETIVO: AMD Stoney Ridge"
    ...
    echo "Comenzando la construcción de la imagen..."
    bash "/cros_workfolder/chromeos-install.sh -src cros_workfolder/recovery.bin -dst output/chromeos.img"
elif [ "$amd_stoneyridge_cros_version" == "9" ]; then
echo "PROCESADOR OBJETIVO: AMD Stoney Ridge"
...
Q14-3
# Leer la respuesta del usuario
read -n 1 amdstoney_brunch_version_97_cros_version
# Limpiar la terminal
clear
# Si la versión escogida es 1 (Chrome OS v96), comenzar la descarga de los archivos necesarios
    if [ "$amdstoney_brunch_version_97_cros_version" == "1" ]; then
        echo "PROCESADOR OBJETIVO: AMD Stoney Ridge"
        echo "VERSIÓN DE BRUNCH FRAMEWORK: r97"
        ...
        echo "Comenzando la construcción de la imagen..."
        bash "/cros_workfolder/chromeos-install.sh -src cros_workfolder/recovery.bin -dst output/chromeos.img"
    elif [ "$amdstoney_brunch_version_97_cros_version" == "2" ]; then
        echo "PROCESADOR OBJETIVO: AMD Stoney Ridge"
        echo "VERSIÓN DE BRUNCH FRAMEWORK: r97"
...
elif [ "$amd_stoneyridge_cros_version" == "10" ]; then
    echo "PROCESADOR OBJETIVO: AMD Stoney Ridge"
...
Q14-4
# Leer la respuesta del usuario
read -n 1 amdstoney_brunch_version_100_cros_version
# Limpiar la terminal
clear
# Si la versión escogida es 1 (Chrome OS v98), comenzar la descarga de los archivos necesarios
    if [ "$amdstoney_brunch_version_100_cros_version" == "1" ]; then
        echo "PROCESADOR OBJETIVO: AMD Stoney Ridge"
        echo "VERSIÓN DE BRUNCH FRAMEWORK: r100"
        ...
        echo "Comenzando la construcción de la imagen..."
        bash "/cros_workfolder/chromeos-install.sh -src cros_workfolder/recovery.bin -dst output/chromeos.img"
    elif [ "$amdstoney_brunch_version_100_cros_version" == "2" ]; then
        echo "PROCESADOR OBJETIVO: AMD Stoney Ridge"
        echo "VERSIÓN DE BRUNCH FRAMEWORK: r100"
        ...
        echo "Comenzando la construcción de la imagen..."
        bash "/cros_workfolder/chromeos-install.sh -src cros_workfolder/recovery.bin -dst output/chromeos.img"
    elif [ "$amdstoney_brunch_version_100_cros_version" == "3" ]; then
        echo "PROCESADOR OBJETIVO: AMD Stoney Ridge"
        echo "VERSIÓN DE BRUNCH FRAMEWORK: r100"
...
elif [ "$amd_stoneyridge_cros_version" == "11" ]; then
    echo "PROCESADOR OBJETIVO: AMD Stoney Ridge"
